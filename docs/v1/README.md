...
| --- | --- | --- |
| [Functional requirements](FUNCTIONAL_REQUIREMENTS.md) | Canonical product contract | Defines user-visible behavior and non-goals. |
...
| [Phase guides](../v1-implementation/) | Runnable delivery guides | Step-by-step terminal commands for each implementation phase. |
